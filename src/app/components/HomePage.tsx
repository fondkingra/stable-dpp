      ...
      <section style={{ padding: '80px 24px', background: '#fafaf8' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
            <div style={{ background: '#fff', padding: '32px', borderRadius: '16px', border: '1px solid #ede8e3', textAlign: 'center' }}>
              ...
              <p style={{ color: '#5a6a7a', fontSize: '14px', lineHeight: 1.6, marginBottom: '24px' }}>Full component tracking for shirt products with end-to-end supply chain visibility — fabric, collar, buttons, threads, and labels.</p>
            ...
            <div style={{ background: '#fff', padding: '32px', borderRadius: '16px', border: '1px solid #ede8e3', textAlign: 'center' }}>
              ...
              <p style={{ color: '#5a6a7a', fontSize: '14px', lineHeight: 1.6, marginBottom: '24px' }}>Denim supply chain verification with complete material provenance — cotton sourcing, dye processes, hardware, and wash compliance.</p>
            ...
            <div style={{ background: '#fff', padding: '32px', borderRadius: '16px', border: '1px solid #ede8e3', textAlign: 'center' }}>
              ...
              <p style={{ color: '#5a6a7a', fontSize: '14px', lineHeight: 1.6, marginBottom: '24px' }}>Jackets, footwear, accessories, and more — contact us to add your category to the StableDPP platform.</p>
              <button style={{ background: 'none', color: '#1ac8b0', border: '1px solid #1ac8b0', padding: '12px 24px', borderRadius: '100px', fontFamily: 'var(--font-primary)', fontSize: '14px', fontWeight: 600, cursor: 'pointer' }}>Contact Us</button>
            </div>
          </div>
        </div>
      </section>
