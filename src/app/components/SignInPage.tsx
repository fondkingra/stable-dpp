    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #071528 0%, #0a1f3c 100%)', fontFamily: 'Inter, sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: '20px', padding: '40px' }}>
          <h1 style={{ fontFamily: 'Merriweather, serif', fontSize: '22px', fontWeight: 900, color: '#0a1f3c', textAlign: 'center', marginBottom: '6px' }}>
            Welcome back
          </h1>
          <p style={{ color: '#7a8a98', fontSize: '14px', textAlign: 'center', marginBottom: '28px' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ textAlign: 'right', marginBottom: '20px' }}>
              <button type="button" style={{ background: 'none', border: 'none', color: '#1ac8b0', fontSize: '13px', cursor: 'pointer' }}>
                Forgot password?
              </button>
            </div>

            <button type="submit" style={{ width: '100%', background: 'linear-gradient(135deg, #1ac8b0, #0ea58c)', border: 'none', cursor: 'pointer', color: '#071528', fontSize: '15px', fontWeight: 700, padding: '13px', borderRadius: '100px', marginBottom: '20px' }}>
              Sign In →
            </button>
